##############################
### VIs and surrogate trees ##
##############################

## This file re-computes the MRF ARRF model with 200 trees and retrieves the VI scores
...
# retraining WTITH VARIABLE IMPORTANCE (VI = T)
set.seed(123)
...
get_cred_ints_and_plots(beta_draws, num_trees, var, h)
...
# the var mp 4 assignment will nto work here as a lagged varaible is the variale to split by 
...
get_cred_ints_and_plots_quarterly(beta_draws, num_trees, var, h)
